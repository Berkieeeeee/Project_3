...
<div class="grid justify-center p-5">
    <form class="grid" method="POST" action="{{route('manager.update', $employee->id)}}">
        @csrf
        @method('PUT')
        <div>
            <label>FirstName:</label><br>
            <input class="outline rounded-lg w-80 border-opacity-25 border-blue-600" type="text" id="firstname" name="firstname" required value="{{$employee->firstname}}">
        </div>
        <div>
            <label>LastName:</label><br>
            <input class="outline rounded-lg w-80 border-opacity-25 border-blue-600" type="text" id="LastName" name="LastName" required value="{{$employee->lastname}}">
        </div>
        <div>
        ...
        <div>
            ...
            <input class="outline rounded-lg w-80 border-opacity-25 border-blue-600" type="text" id="address" name="address" required value="{{$employee->address}}">
        </div>
        <div>
            <label>city:</label><br>
            <input class="outline rounded-lg w-80 border-opacity-25 border-blue-600" type="text" id="city" name="city" required value="{{$employee->city}}">
        </div>
        <div>

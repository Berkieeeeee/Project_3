...
<ul class="grid justify-center m-2 gap-2">
    @foreach($staff as $employee)
        <div class="flex space-x-2">
            ...
            <p class="bg-green-700 rounded-l"><a class="text-black" href="{{route('manager.edit', ['employee' => $employee->id])}}">Edit employee</a></p>
            <form class="bg-red-600 rounded-l" method="post" action="{{route('manager.destroy', $employee->id)}}">
                @csrf
                @method('DELETE')

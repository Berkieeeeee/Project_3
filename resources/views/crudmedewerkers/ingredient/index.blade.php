...
<head>
    ...
    <title>Avalible Ingredient's</title>
...
<header>
    ...
    <nav style="display: flex; flex-direction: row; width: 100%; flex-wrap: wrap; align-content: center; align-items: center; justify-content: center;">
        <ul>
            ...
            <li><a href="/crudmedewerkers/pizza/edit">Edit Ingredient's</a></li>
            <li><a href="/crudmedewerkers/pizza/create">Creat Ingredient's</a></li>
            <li><a href="/crudmedewerkers/pizza/index">Remove Ingredient's</a></li>
        </ul>
    </nav>
</header>

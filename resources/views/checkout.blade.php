...
<header><img src="PizzaFotos/_09253db4-5f28-4da4-b255-46c05fda052b-removebg-preview.png" alt="StonksFoto" width="100"
             style="
                position: absolute;
            ">
    <nav style="
...
<main>
    <div class="flex justify-evenly">
        <div id="info" class="info flex flex-col justify-evenly p-5 overflow-auto">
            ...
            <div class="total-price-label">Total Price: <span class="text-black" id="total-price"></span></div>
        </div>
        ...
        <form id="form" class="form" method="POST" action="{{ route('checkout.store') }}">
            ...
            <button type="submit" class="bg-stonks-red hover:bg-hover-stonks-red text-white font-bold py-2 px-4 rounded">
                Complete Purchase
            </button>
        </form>
    </div>
...
<footer class="flex items-center flex-col">
    <div class="card">
        ...
        <a href="https://twitter.com/StonksPizza_NL" class="socialContainer containerTwo">
        ...
        <a href="https://www.linkedin.com/in/stonks-pizza-36b720252/" class="socialContainer containerThree">

...
<div class="main-content">
    <div class="container">
        <section class="section">
            <h1 class="text-4xl text-center font-semibold">Most popular pizzas</h1>
            <div class="grid">
                <div class="grid-item">
                    <img src="/PizzaFotos/TonijnPizza.png" alt="Tonijn Pizza">
                    <h2>Tonijn Pizza</h2>
                    <p>A delicious combination of flavors</p>
                ...
                <div class="grid-item">
                    <img src="/PizzaFotos/BarbecueChicken.png" alt="Barbeque Chicken Pizza">
                    <h2>Barbeque Chicken Pizza</h2>
                    <p>Smoky and savory</p>
                    <button class="Information-button"><a href="order">More Information</a></button>
                </div>
            </div>
        </section>
